...
const RegisterForm = () => {
    ...
    return (
        <div className="p-5">
            ...
            {/* Form */}
            <form className="flex flex-col gap-5 w-full mb-5 mt-5" onSubmit={handleSubmit}>
                ...
                <button disabled={!email || !password} type="submit" className="text-white bg-blue-500 hover:bg-blue-800 disabled:bg-blue-300 font-medium rounded-lg w-full text-sm px-5 py-2.5 me-2 mb-2">Register</button>
            </form>
        </div>
    )
}
